...
import com.p5.adoptionsapi.repository.users.*;
...
public class AdoptionUserDetailsService implements UserDetailsService {
    ...
    public AdoptionUserDetailsService(UserRepository userRepository, RoleRepository roleRepository, AdoptionsPasswordEncoder passwordEncoder) {
    ...
    private CommandLineRunner setUpDefaultUser() {
        return args -> {
            final String defaultEmail = "pentastagiu@mail.io";

package com.p5.adoptionsapi.units;
...
public class AnimalShelterServiceTest {
   ...
   this.shelterJPA= ShelterAdapter.fromDTO(shelterDTO);
    ...
    @Test
    public void testValidateShelter_RunOK() {
    ...
    public void createShelter_SavesOK() {
        ...
        Mockito.when(animalShelterRepositoryMock.save(Mockito.any())).thenReturn(shelterJPA);
    ...
    {
        animalShelterService.deleteById(shelterDTO.getId());
